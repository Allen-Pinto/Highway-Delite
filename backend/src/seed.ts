...
const seedDatabase = async () => {
  try {
    ...
    console.log(`   - South India: 8 experiences`);
    console.log(`   - North India: 8 experiences`); 
    console.log(`   - West & East: 9 experiences`);
    
    console.log('\n🎯 Experience Categories:');
    const categories = experiences.reduce((acc: any, exp) => {
